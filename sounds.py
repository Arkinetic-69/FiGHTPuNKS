...
class Sounds:
    ...
    def __init__(self):
        ...
        self.sound_effects = {
            'combat':{'atk 1': r'assets\audio\sfx\combat\atk_1.wav', 
             'atk 2': r'assets\audio\sfx\combat\atk_2.wav',
             'jump': r'assets\audio\sfx\combat\jump.wav',
             'block': r'assets\audio\sfx\combat\block.wav',
             'hit': r'assets\audio\sfx\combat\hit.wav',
             'death': r'assets\audio\sfx\combat\death.wav'
            },
    ...
    def play_sound_effect(self, effect):
        ...
        try:
            if effect in self.sound_effects['combat']:
                ...
                sound.set_volume(1)  # Slightly louder for combat sounds
                sound.play()
    ...
    def play_combat_sound(self, action_type):
        ...
        if action_type in combat_sound_map.keys():
